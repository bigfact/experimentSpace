...
/**
 * 根据小项目的 package.json 文件生成小项目列表到 readme 文件中
 */
gulp.task('list', function () {
	var listFilePath = './README.md';
	var readmeData = fs.readFileSync('./README.main.md');
	fs.writeFileSync(listFilePath, readmeData + '\n## 小项目列表\n\n');
